...
void protobuf_AssignDesc_ConfigItem_2eproto() {
  ...
  static const int PropItem_offsets_[10] = {
...
void protobuf_AddDesc_ConfigItem_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "ftConfig.proto\"\324\002\n\010PropItem\022\n\n\002id\030\001 \002(\r\022"
    "\020\n\010location\030\002 \002(\r\022\024\n\014unlock_level\030\003 \002(\r\022"
    "\021\n\ttime_gain\030\004 \002(\r\0221\n\005price\030\005 \002(\0132\".Comm"
    "onGiftConfig.CommonModifyItem\022\020\n\010limitnu"
    "m\030\006 \002(\r\0227\n\013dimond_cost\030\007 \002(\0132\".CommonGif"
    "tConfig.CommonModifyItem\0224\n\010material\030\010 \001"
    "(\0132\".CommonGiftConfig.CommonModifyItem\022\023"
    "\n\013speed_price\030\t \001(\r\0228\n\014extra_reward\030\n \001("
    "\0132\".CommonGiftConfig.CommonModifyItem\"-\n"
    "\005Items\022$\n\006itemes\030\001 \003(\0132\024.ConfigItem.Prop"
    "Item", 444);
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(24)) goto parse_unlock_level;
        break;
      }
      ...
      case 3: {
        ...
        if (input->ExpectTag(32)) goto parse_time_gain;
        break;
      }
      ...
      case 5: {
        ...
        if (input->ExpectTag(48)) goto parse_limitnum;
        break;
      }
      ...
      case 6: {
        ...
        if (input->ExpectTag(58)) goto parse_dimond_cost;
        break;
      }
      ...
      case 9: {
        ...
        if (input->ExpectTag(82)) goto parse_extra_reward;
        break;
      }
...
void PropItem::SerializeWithCachedSizes(
  ...
  // required uint32 unlock_level = 3;
  if (has_unlock_level()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(3, this->unlock_level(), output);
  }

  // required uint32 time_gain = 4;
  if (has_time_gain()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(4, this->time_gain(), output);
  }
  ...
  // required uint32 limitnum = 6;
  if (has_limitnum()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(6, this->limitnum(), output);
  }

  // required .CommonGiftConfig.CommonModifyItem dimond_cost = 7;
  if (has_dimond_cost()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      7, this->dimond_cost(), output);
  }
...
::google::protobuf::uint8* PropItem::SerializeWithCachedSizesToArray(
  ...
  // required uint32 unlock_level = 3;
  if (has_unlock_level()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(3, this->unlock_level(), target);
  }

  // required uint32 time_gain = 4;
  if (has_time_gain()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(4, this->time_gain(), target);
  }
  ...
  // required uint32 limitnum = 6;
  if (has_limitnum()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(6, this->limitnum(), target);
  }
