...
static bool HttpRequest(string &response, HttpRequestType type, const string &url, const char *data = NULL, const map<string, string> *headers = NULL, const char *cookie = NULL)
{
...
bool Network::HttpGetRequestWithCookie(string &response, const string &url, const string &cookie)
{
	return ::HttpRequest(response, HTTP_GET, url, NULL, NULL, cookie.c_str());
}
