...
bool CSemaphoreLock::Create(const char *name, int semid)
{
...
bool CSemaphoreLock::Open(const char *name, int semid)
{
...
bool CSemaphoreLock::CreateOrOpen(const char *name, int semid)
{
...
bool CSemaphoreLock::Lock(int vnum)
{
	if(m_sem == SEM_FAILED)
	{
		return false;
...
bool CSemaphoreLock::Unlock(int vnum)
{
	if(m_sem == SEM_FAILED)
	{
		return false;
