...
int CDataHelpHist::AddHelpHist(unsigned uid, unsigned ts, const string &data)
{
...
int CDataHelpHist::GetHelpHist(unsigned uid, vector<DataHelpHistory> &datas)
{
...
int CDataHelpHist::RemoveHelpHistBeforeTs(unsigned uid, unsigned ts)
{
